    ...
    return (
        <Card className="@container/card bg-gradient-to-br from-muted/50 to-muted">
            <CardHeader>
                ...
                <CardDescription>
                    <span className="hidden @[540px]/card:block">Temperature & Humidity Trends.</span>
                ...
                <CardAction>
                    ...
                    >
                        <ToggleGroupItem className="cursor-pointer border-white/50" value="weekly">
                            1 Week
                        </ToggleGroupItem>
                        <ToggleGroupItem className="cursor-pointer border-white/50" value="daily">
                            {' '}
                            Day
                        </ToggleGroupItem>
                        <ToggleGroupItem className="cursor-pointer border-white/50" value="hourly">
                            1 Hour
                        </ToggleGroupItem>
                    </ToggleGroup>
